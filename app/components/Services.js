...
const Services = () => {
  ...
  return (
    <section
      id="services"
      ref={ref}
      className={`relative ${SPACING.section.py} bg-white overflow-hidden`}
    >
      {/* Background pattern */}
...
const ServiceCard = ({ service, index, isInView }) => {
  ...
  return (
    ...
    >
      ...
      {/* Title */}
      <h3
        className={`text-xl md:text-2xl font-semibold mb-4 md:mb-6 ${ANIMATIONS.transitions.default} ${
      ...
      <div className="space-y-2 md:space-y-3">
        {service.features.map((feature, featureIndex) => (
          ...
          >
            <div
              className={`w-1.5 h-1.5 md:w-2 md:h-2 rounded-full mr-2 md:mr-3 ${
